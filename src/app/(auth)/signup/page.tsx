...
export default function Signup() {
  ...
  return (
      <div className="container">
        {isMobile ? (
            <>
              <div className="w-4/5 mx-auto rounded-none p-4  shadow-input bg-white dark:bg-black mt-5">
                <div className="flex flex-row justify-between items-center">
                  ...
                  <button  onClick={() => setIsAdmin(!isAdmin)} data-cursor-pointer className="overflow" >
                    <motion.div
                        initial={{ x: 0 }}
                        whileHover={{ x: -5 }}
              ...
              {loading && ( <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50" > <Loader loadingStates={loadingStates} loading={loading} duration={1500} /> </div>)}
            </>
        ) : (
            <>
